...
plot_usmap(data = youngvoters2016, values = "Voter Turnout Rate 2016", regions = "states") +
  scale_fill_gradient(low = "lightyellow", high = "darkred", name = "Turnout Rate", na.value = "gray90", limits = c(20,75.3)) +
...
## Top 10 States With Highest Voter Turnout Rates (2020) Ages 18 - 24
```{r echo = FALSE}
...
## Top 10 States With Highest Political Ad Spending on Google
```{r echo = FALSE}
